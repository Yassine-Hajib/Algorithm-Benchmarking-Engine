          ...
          <div className="bm-workspace">
            <header className="bm-header">
              ...
              <div className="bm-header-right">
                ...
                {isDual ? <span className="bm-badge bm-badge--dual">Dual Mode</span> : <span className="bm-badge bm-badge--single">Single Mode</span>}
              </div>
            </header>

            <div className="bm-body">
              <aside className="bm-left">
                <div className="bm-section-label"><span className="bm-dot" /> Input Parameters</div>
                ...
                <button className="bm-run-btn" onClick={handleRun} disabled={loading || !inputData.trim()}>
                  {loading ? <><span className="bm-spinner" /> Analysis In Progress...</> : <>{Ico.Play} Run Benchmark {Ico.Arrow}</>}
                </button>
        ...
        {JSON.stringify(result.result, null, 2)}
                ...
                {!result && !loading && (
                  <div className="bm-empty">
                    ...
                    <p className="bm-empty-sub">This component is now disconnected from local simulation and ready for FastAPI.</p>
                  </div>
                )}
              </div>
            </div>
